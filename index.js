...
let checkingAccountNumber = document.getElementById("checking_account_number").value;
let correspondentCheckNumber = document.getElementById("correspondent_check_number").value;
